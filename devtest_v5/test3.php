        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if ($monthYear !== $currentMonth) {
                    ...
                    ?>
                    <h2 style="text-align: left;padding: top 10px;"><?php echo htmlspecialchars($currentMonth); ?></h2>
                    <table width="800" style="overflow-x: auto;">
                        <thead>
                            <tr>
                                <th style="text-align: left;" width="200" align="left">Customer</th>
                                <th style="text-align: left;" width="400" align="left">Products Bought</th>
                                <th style="text-align: right;" width="200" align="right">Total</th>
                            </tr>
                        </thead>
                        <tbody>
                    <?php
                ...
                ?>
                <tr>
                    <td style="text-align: left;"  valign="top"><?php echo htmlspecialchars($row['customer']); ?></td>
                    <td style="text-align: left;" ><?php echo str_replace(',', '<br>', htmlspecialchars($row['products'])); ?></td>
                    <td style="text-align: right;"  valign="bottom" align="right"><?php echo 'R ' . number_format($row['sales_total'], 2); ?></td>
                </tr>
                <?php
            }
            echo '</tbody></table>';
